...
import { VendorOnboarding01Screen } from '../screens/vendor/VendorOnboarding01Screen';
...
export const RootNavigator: React.FC = () => {
  return (
    ...
    >
      ...
      <Stack.Screen name={Routes.VENDOR_ONBOARDING_1} component={VendorOnboarding01Screen} />
    </Stack.Navigator>
  );
};
